(defproject ympd "0.1.0-SNAPSHOT"
  :description "TODO"
  :url "TODO"
  ...
  :cljsbuild {
    :builds [
      {:id "debug"
       :source-paths ["src"]
       :figwheel {:on-jsload "ympd.core/on-figwheel-reload!"}
       :compiler {:asset-path "js/debug/out"
                  :output-to "resources/js/debug/ympd.js"
      ...
      {:id "release"
       ...
       :compiler {:asset-path "js/release/out"
                  :output-to "resources/js/release/ympd.js"
